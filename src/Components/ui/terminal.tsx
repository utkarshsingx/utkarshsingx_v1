...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        'z-0 h-full w-full max-w-lg rounded-xl border',
        'border-[var(--theme-border,#233554)] bg-[var(--theme-bg,#0a192f)]',
        className
      )}
    >
      <div className="flex flex-col gap-y-2 border-b border-[var(--theme-border,#233554)] p-4">
