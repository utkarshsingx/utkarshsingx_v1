  ...
  return (
    <section className="relative min-h-screen h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 sm:px-6 text-center">
        <div className="flex flex-col items-center gap-6 p-8 rounded-xl border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm max-w-md">
          ...
          <ShinyText
            text="Sign in with your Google account to access the admin panel."
            className="text-slate-400 text-sm text-center max-w-xs block"
            color="#64748b"
            shineColor="#64ffda"
            speed={2.5}
            spread={100}
