      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 sm:px-6 text-center">
        <div className="flex flex-col items-center gap-8 p-10 sm:p-12 rounded-2xl border border-slate-600/40 bg-slate-900/60 backdrop-blur-xl shadow-2xl shadow-black/30 max-w-md w-full">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-slate-400 text-xs sm:text-sm">Secure access to your portfolio admin</p>
          </div>
          <ShinyText
            text="Sign in with your Google account to access the admin panel."
            className="text-slate-400 text-sm text-center max-w-sm block leading-relaxed"
            color="#64748b"
            shineColor="#64ffda"
            speed={2.5}
            spread={100}
